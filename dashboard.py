...
st.markdown(
    ...
    f"{_logo_tag}"
    f'<span class="dashboard-title-text">LLM Inference Performance Dashboard</span>'
    f"</div>",
    unsafe_allow_html=True,
)
...
def main():
    ...
    # Add floating AI Performance Agent button (visible on all views)
    st.markdown(
        """
        <style>
        .floating-ai-button {
        ...
        <div class="floating-ai-button">
            <a href="https://aidash-agent.apps.ocp4.intlab.redhat.com" target="_blank">
